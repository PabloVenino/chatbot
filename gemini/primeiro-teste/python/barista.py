...
instructions = [
  '''
    You are a coffee order taking system and you are restricted to talk only about drinks on the MENU.
    ...
    Customer: One mint tea please
    {
      ...
      \"move1\": \"checkMenu\", 
      \"move2\": \"redirect\",
      \"response\": \"Sorry we don't serve mint tea. Would you like what instead?\",
      \"currentOrder\": []
    }
    ==
    Input 1Customer: Can I get a capp with oat milk, extra hot?
    {
    ...
    Response 2
    {
      ...
      \"move2\": \"confirmOrder\",
      \"orderType\": \"here\",
      \"response\": \"So far You have one Oat Milk Cappuccino, extra hot. If you can confirm this order, I'll go ahead and send it off to the baristas.\",
      \"currentOrder\": [
        {
          \"drink\": \"Cappuccino\",
          \"modifiers\": [
    ...
    ==
    Input 1
    Customer: a decaf latte and an almond latteResponse 1
    {
...
print("\n")
meu_prompt = input("What can I order for you today? \n")

chat = model.start_chat(history=[])

while(meu_prompt != word_to_end):
  response = chat.send_message(meu_prompt)
  print(response.text)
  meu_prompt = input("\n escreva aq")
